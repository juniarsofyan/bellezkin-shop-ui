                ...
                <div class="checkout-wrapp">
                    ...
                    <div class="shipping-address-form-wrapp">
                        <div class="shipping-address-form checkout-form">
                            ...
                            <!-- Branch : {{ branch }} -->
                            <div
                                class="row-col-2 row-col checkout-form"
                                style="padding-left: 27px;padding-bottom: 0px; padding-top:20px;"
                            >
                                <div class="your-order">
                                    <h3
                                        class="title-form text-center"
                                    ...
                                    <table style="border:none !important;">
                                        <tr style="border:none !important;">
                                            <td
                                                style="border:none !important;padding-bottom:0px"
                                            >Total items :</td>
                                            <td
                                                style="border:none !important;padding-bottom:0px"
                                                class="text-right"
                                    ...
                                    <table style="border:none !important;">
                                        ...
                                        <tr v-if="shipment.fee" style="border:none !important;">
                                            <td
                                                style="border:none !important;padding-bottom:0px;color:green;"
                                            >Shipping Fee</td>
                                            <td
                                                style="border:none !important;text-align:right;padding-bottom:0px;color:green;"
                                                class="text-right"
                                            >
                                    ...
                                    <div class="modal-wrapper">
                                        <div class="modal-container">
                                            ...
                                            <div class="modal-body">
                                                <slot name="body">
                                                    ...
                                                    <input
                                                        ...
                                                        value="1"
                                                        v-model="address_form.is_default"
                                                    />
                                            ...
                                            <div class="modal-footer">
                                                <slot name="footer">
                                                    <button
                                                        class="modal-default-button btn-sm"
    ...
    methods: {
        ...
        async checkOngkir(event) {
            let shipment = {
                ...
                destination_subdistrict_id: this.default_shipping_address
                    .kecamatan_id,
                ...
                .then((response) => {
                    if (response.data.data != 0) {
                        ...
                        this.$store.dispatch(
                            ...
                            this.default_shipping_address.id
                        )
                    } else {
                        this.$store.dispatch(
                            'checkout/setDeliveryAddress',
        ...
        getCities: function(province_id) {
            this.$axios
                .get(`ongkir/province/` + province_id + `/cities`)
                .then((response) => {
                    if (response.data.data != 0) {
        ...
        getSubdistricts: function(city_id) {
            this.$axios
                .get(`ongkir/city/` + city_id + `/subdistricts`)
                .then((response) => {
                    if (response.data.data != 0) {
            ...
            if (this.validateAddress()) {
                ...
                this.$axios
                    .post(`shipping-address/add`, {
                        ...
                        subdistrict_id: this.address_form.subdistrict
                            .subdistrict_id,
                        subdistrict_name: this.address_form.subdistrict
                            .subdistrict_name,
        ...
        validateAddress() {
            if (
                !this.address_form.hasOwnProperty('name') ||
                this.address_form.name == ''
            ) {
                return false
            }

            if (
                !this.address_form.hasOwnProperty('phone') ||
                this.address_form.phone == ''
            ) {
                return false
            }

            if (
                !this.address_form.hasOwnProperty('province') ||
            ...
            if (
                !this.address_form.hasOwnProperty('city') ||
            ...
            if (
                !this.address_form.hasOwnProperty('subdistrict') ||
            ...
            if (
                !this.address_form.hasOwnProperty('address') ||
                this.address_form.address == ''
            ) {
                return false
            }
            ...
            if (
                !this.address_form.hasOwnProperty('postcode') ||
                this.address_form.postcode == ''
            ) {
                return false
            }
